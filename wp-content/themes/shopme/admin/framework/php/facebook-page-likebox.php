...
class Shopme_FacebookPageLikebox {
	...
	function facebook_page_plugin_likebox($attr) {
		...
		$output = '<div class="fb-page" data-height="350" data-href="'. esc_url($page_name) . '" data-hide-cover="' . $hide_cover . '" data-show-facepile="' . $show_facespile . '" data-show-posts="' . $show_posts . '"><div class="fb-xfbml-parse-ignore"></div></div>';
