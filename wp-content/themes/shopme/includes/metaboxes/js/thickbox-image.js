jQuery( function ( $ ) {
	...
	$( 'body' ).on( 'click', '.mad-thickbox-upload', function () {
		var $this = $( this ),
			$holder = $this.siblings( '.mad-images' ),
			post_id = $( '#post_ID' ).val(),
		...
		window.send_to_editor = function ( html ) {
			...
			html = '<li id="item_' + id + '">';
			html += '<img src="' + url + '">';
			html += '<div class="mad-image-bar">';
			html += '<a class="mad-delete-file" href="#" data-attachment_id="' + id + '">×</a>';
			html += '</div>';
