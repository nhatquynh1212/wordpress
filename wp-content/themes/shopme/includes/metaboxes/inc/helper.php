...
class MAD_Helper {
	...
	public static function hash_fields( $post_type ) {
		...
		$meta_boxes = MAD_Core::get_meta_boxes();
		foreach ( $meta_boxes as $meta_box ) {
			$meta_box = MAD_RW_Meta_Box::normalize( $meta_box );
	 ...
	 * This function finds field in meta boxes registered by 'mad_meta_boxes' filter.
	 *
	...
	public static function find_field( $field_id, $post_id = null ) {
		...
		return MAD_Field::call( 'normalize', $field );
	}
	...
	public static function meta( $key, $args = array(), $post_id = null ) {
		...
		switch ( $args['type'] ) {
			...
			case 'map':
				...
				$meta  = MAD_Map_Field::the_value( $field, $args, $post_id );
				break;
			case 'oembed':
				$meta = MAD_OEmbed_Field::the_value( $field, $args, $post_id );
				break;
			default:
				$meta = MAD_Field::call( 'get_value', $field, $args, $post_id );
		}
