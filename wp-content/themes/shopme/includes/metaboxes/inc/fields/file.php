...
class MAD_File_Field extends MAD_Field {
	...
	public static function html( $meta, $field ) {
		$i18n_title = apply_filters( 'mad_file_upload_string', _x( 'Upload Files', 'file upload', 'shopme' ), $field );
		$i18n_more  = apply_filters( 'mad_file_add_string', _x( '+ Add new file', 'file upload', 'shopme' ), $field );
	...
	protected static function file_html( $file ) {
		$i18n_delete = apply_filters( 'mad_file_delete_string', _x( 'Delete', 'file upload', 'shopme' ) );
		$i18n_edit   = apply_filters( 'mad_file_edit_string', _x( 'Edit', 'file upload', 'shopme' ) );
