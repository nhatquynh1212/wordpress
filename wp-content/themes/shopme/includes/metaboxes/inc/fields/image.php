 ...
 */
class MAD_Image_Field extends MAD_File_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'mad-image', MAD_CSS_URL . 'image.css', array(), MAD_VER );
	}
	...
	public static function file_html( $image ) {
		...
		return sprintf(
			'<li id="item_%s">
				<img src="%s">
				<div class="mad-image-bar">
					<a href="%s" target="_blank"><span class="dashicons dashicons-edit"></span></a> |
					<a class="mad-delete-file" href="#" data-attachment_id="%s">&times;</a>
				</div>
			</li>',
			$image,
			$src,
