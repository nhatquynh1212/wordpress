 ...
 */
abstract class MAD_Choice_Field extends MAD_Field {
	...
	public static function filter_options( $field, $options ) {
		...
		foreach ( $options as &$option ) {
			$option         = apply_filters( 'mad_option', $option, $field );
			$option->$label = apply_filters( 'mad_option_label', $option->$label, $option, $field );
		}
		return $options;
	}
